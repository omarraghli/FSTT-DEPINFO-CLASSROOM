  ...
  <div class="panel-body">
      ...
      <div class="well">
        ...
        @if($noteactuelle < 10 && $noteactuelle> 0) <div style="color: red;font-size: x-large;">Vous avez eu: {{$noteactuelle}}/20
          ...
          margin-left: 15px; ">
              ...
              <form method="post" action="{{ url('/project/' . $projet_id .  '/student/'.Auth::user()->id.'/entreprise/'.$Projet->entreprise_id) }}" enctype="multipart/form-data">
    ...
    cursor: pointer;
            ...
            <div>
              ...
              <div>
                <iframe src="{{ url('/fichiers/project/' . $projet_id . '/student/'. $user_id.'/'.$affected_project) }}" style="border-style: none; border-radius: 15px;border: 1px solid black; width: 100%; height:250px;" frameborder="0"></iframe>
              </div>
              <form method="post" action="{{ url('/project/'.$projet_id.'/student/'.$user_id.'/downlaodStuProjet/' .$affected_project) }}">
