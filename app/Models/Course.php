...
class Course extends Model
{
     ...
     */
    protected $fillable = [
        'subject', 'title', 'course', 'section','semestre','filier'
    ];
    ...
    {
        $this->attributes['semestre'] = ucwords($value);
    }

    public function setFilierAttribute($value) 
    {
        $this->attributes['filier'] = ucwords($value);
    }
